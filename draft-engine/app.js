...
async function compose(){
  ...
  const w=weightsFor(tokens),patterns=candidates(w),globalScales=[1,.96,.92],openingCandidates=state.agentSettings.openingLines?[state.agentSettings.openingLines]:[4,5,3],total=patterns.length*globalScales.length*openingCandidates.length;
